...
const PRICING_PLANS = [
  {
    ...
    color: 'gray',
    features: [
      { text: 'Limited past papers (1-2 years)', included: true },
      { text: 'View PDFs', included: true },
      { text: 'Basic practice mode (5 questions)', included: true },
      { text: 'Basic bookmarking', included: true },
      { text: 'Unlimited answers', included: false },
      { text: 'Full paper access', included: false },
      { text: 'Exam analytics', included: false },
      { text: 'Offline mode', included: false },
      { text: 'AI checking', included: false },
    ],
  ...
  },
  {
    ...
    color: 'blue',
    features: [
      { text: 'Full access to all papers', included: true },
      { text: 'Mark schemes', included: true },
      { text: 'Unlimited practice', included: true },
      { text: 'Save answers', included: true },
      { text: 'Subject progress tracking', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'AI answer checking', included: true },
      { text: 'Predicted grades', included: true },
      { text: 'Weak-topic analysis', included: true },
      { text: 'Smart revision plans', included: true },
      { text: 'Timed mock exams', included: true },
      { text: 'Performance graphs', included: true },
      { text: 'AI tutor/chat assistant', included: true },
  ...
  },
  {
    ...
    color: 'amber',
    features: [
      { text: 'All Premium AI features', included: true },
      { text: 'Single Subject - 199 MVR', included: true },
      { text: 'Science Bundle - 499 MVR', included: true },
      { text: 'Full O Level - 999 MVR', included: true },
      { text: 'Never pay monthly', included: true },
      { text: 'Cancel Anytime', included: true },
    ],
    cta: 'View Lifetime Plans',
    popular: false,
  },
];
