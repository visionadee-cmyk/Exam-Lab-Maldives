...
const dir = 'C:/Users/maushaz.MADIHAA/Desktop/Rettey/exam-lab-maldives/exam-lab-mv/public/pdf-pastpaer-q&a/O-Level/Economics-0455';
const subjectName = 'Economics-0455';
...
for (const file of fs.readdirSync(dir)) {
  ...
  if (!file.toLowerCase().startsWith('0455_')) continue;
