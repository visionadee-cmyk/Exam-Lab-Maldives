...
const dir = 'C:/Users/maushaz.MADIHAA/Desktop/Rettey/exam-lab-maldives/exam-lab-mv/public/pdf-pastpaer-q&a/O-Level/EnglishFirstLanguage-0500';
const subjectName = 'EnglishFirstLanguage-0500';
...
for (const file of fs.readdirSync(dir)) {
  ...
  if (!file.toLowerCase().startsWith('0500_')) continue;
