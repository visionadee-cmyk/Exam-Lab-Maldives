...
const dir = 'C:/Users/maushaz.MADIHAA/Desktop/Rettey/exam-lab-maldives/exam-lab-mv/public/pdf-pastpaer-q&a/O-Level/Chemistry-0620';
const subjectName = 'Chemistry-0620';
...
for (const file of fs.readdirSync(dir)) {
  ...
  if (!file.startsWith('0620_')) continue;
